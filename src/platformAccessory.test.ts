...
describe('platformAccessory', () => {
  ...
  // read-through cache
  // on first get, make API call
  // on second get with time window,
  // on get outside of time window,


  // polling -> if it's on standby, poll every 15m
  // if it's actively changing, poll every 1.5s?


  // how to handle rate limiting?
  // log a warning
  // reduce polling frequency
  // bubble up an error on the accessory somehow?
